    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                @endif
                    <div class="flex">
                        <a class="" href="{{ route('penjamin.create') }}"><button
                    ...
                    <div class="overflow-x-auto relative">
                        <table class="w-full text-sm text-left text-gray-500 ">
                            ...
                            <tbody>
                                @foreach ($penjamin as $key => $p)
                                    <tr class="bg-white ">
                                        <td class="py-4 px-6">{{ $key + 1 }}</td>
                                        <td class="py-4 px-6">{{ $p->nama }}</td>
                                        <td>
                                            <div class="m-3">
                                                <a href="{{ route('penjamin.edit', $p->id) }}"><button type="button"
                                        ...
                                        bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">Edit</button>
                                            ...
                                            <div class="m-3">
                                                <form action="{{ route('penjamin.destroy', $p->id) }}" method="POST">
                                                    @csrf
                                                    @method('delete')
                                                    <button type="submit"
                                                        class="py-2 px-3 text-xs font-medium text-center text-white
