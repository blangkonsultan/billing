        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="mb-6">
                        <h1 class="text-center text-5xl font-extrabold dark:text-black">EDIT TINDAKAN</h1>
                    </div>
                    <form action="{{ route('ms_tindakan.update', $ms_tindakan->id) }}" method="POST">
                        @csrf
                        @method('put')
                        <div class="mb-6">
                            <label for="text"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-black-300">NAMA</label>
                            <input type="text" value="{{ $ms_tindakan->nama }}" name="nama"
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" value="{{ $ms_tindakan->harga }}" name="harga"
                                class="shadow-sm bg-white-50 border border-gray-300 text-black-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                placeholder="">
