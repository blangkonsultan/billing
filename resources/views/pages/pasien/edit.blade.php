        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="mb-6">
                        <h1 class="text-center text-5xl font-extrabold dark:text-black">EDIT PASIEN</h1>
                    </div>
                    <form action="{{ route('pasien.update', $pasien->id) }}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" value="{{ $pasien->nama }}" name="nama"
                        ...
                        <div class="mb-6">
                            <label for="date"
                                ...
                                LAHIR</label>
                            <input type="date" value="{{ date('Y-m-d', strtotime($pasien->tgl_lahir)) }}" name="tgl_lahir"
                                class="shadow-sm bg-white-50 border border-gray-300 text-black-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                placeholder="">
                        ...
                        <div class="mb-6">
                            ...
                            <select name="jenis_kelamin"
                                ...
                                <option value="2" {{ $pasien->jenis_kelamin == '2' ? 'selected' : '' }}>Wanita
                                </option>
                            </select>
                        ...
                        <div class="mb-6">
                            ...
                            <input type="textarea" value="{{ $pasien->alamat }}" name="alamat"
                                class="shadow-sm bg-white-50 border border-gray-300 text-black-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                placeholder="">
